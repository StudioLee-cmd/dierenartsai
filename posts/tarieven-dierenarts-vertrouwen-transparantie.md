...
![Receptie van een Nederlandse dierenartspraktijk met een kalender en kassa op de balie](/images/blog/tarieven-dierenarts-vertrouwen-transparantie-2.jpg)
...
1. **Algemene uitleg.** "Onze prijzen zijn gebaseerd op tijd, materialen en complexiteit. Hieronder vindt u indicaties voor de meest voorkomende behandelingen."

2. **Tabel met bandbreedtes.** Niet "€85" maar "€80 - €110" voor consulten. Dit voorkomt dat een klant boos wordt als zijn factuur €98 is.
...
3. **Wat de prijs bepaalt.** "Operaties hebben verschillende prijzen op basis van de duur, de noodzakelijke materialen en eventuele complicaties. U krijgt altijd vooraf een schatting voor we beginnen."

4. **Wat te doen bij budget-zorgen.** "Als de prijs een belemmering is, bespreek dit gerust. We denken graag mee over een betalingsregeling of alternatieven."

Een [website voor dierenartsen](/gratis-website) met deze opbouw verlaagt achteraf-klachten significant. Bekijk onze [tarieven](/tarieven) voor onze eigen managed-service als je dit liever volledig laat verzorgen.
...
1. **Maak vandaag de prijzen-pagina:** vier elementen, bandbreedtes voor 6-8 standaard-behandelingen.
2. **Train je receptie:** alle medewerkers moeten dezelfde prijs-bandbreedtes uit hun hoofd kennen voor telefonische vragen.
3. **Maak een spreekkamer-script:** korte zin die voor elke extra ingreep wordt uitgesproken voordat de behandeling start.
4. **Print een eenvoudige prijslijst:** bij de balie als referentie voor zowel medewerker als klant.
5. **Update factuur-template:** maak duidelijk welke kosten zijn toegevoegd ten opzichte van de eerste schatting.

Onze [chatbot voor dierenartsen](/chatbot) op je website kan ook automatisch prijs-indicaties geven aan bezoekers, op basis van de behandelingen die je aanbiedt.

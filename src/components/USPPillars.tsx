...
const pillars = [
    {
        ...
        pillarLinks: [{ href: "/voice-ai", anchor: "ai telefonist voor dierenartsen" }, { href: "/chatbot", anchor: "ai chatbot voor dierenartsen" }],
    },
    {
        ...
        icon: <FiStar size={32} />,
        pillarLinks: [{ href: "/seo", anchor: "seo voor dierenartsen" }, { href: "/reviews", anchor: "review management voor dierenartsen" }],
    },
    {
        ...
        pillarLinks: [{ href: "/automatisering", anchor: "workflow automatisering voor dierenartsen" }, { href: "/crm", anchor: "crm voor dierenartsen" }],
    },
    {
        ...
        pillarLinks: [{ href: "/gratis-website", anchor: "gratis website voor dierenartsen" }],
    }
];

...
export const voiceDemos: VoiceDemoOpname[] = [
    {
        ...
        richting: 'Een baasje belt over een hond die niet eet; de agent schat de urgentie in en plant een consult.',
        stem: 'Thomas',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Een klant wil de jaarlijkse vaccinatie-afspraak verzetten naar een avond.',
        stem: 'Sanne',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Iemand vraagt 's avonds wat een castratie kost en of dat op dezelfde dag kan.',
        stem: 'Eva',
        src: null,
        duur: null,
    },

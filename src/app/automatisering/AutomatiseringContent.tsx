...
const niche = siteDetails.niche?.toLowerCase() || "dierenartsen";
...
const workflows = [
  ...
  },
  {
    ...
    desc: `Klantspecifieke onderhoud- of opvolg-cycli automatisch beheerd. Voor Dierenartsen: vaccinatie-herinneringen, spoed-call-handling buiten kantooruren, automatische afspraakbevestigingen voor consulten — terugkerende omzet zonder dat jij eraan hoeft te denken.`,
  },
];
...
const integrations = [
  { icon: BsWhatsapp, title: "WhatsApp Business", desc: "Het hoofdkanaal — 90% van dierenartsen-klanten checkt WhatsApp sneller dan e-mail." },
...
const painPoints = [
  {
    icon: BsXCircle,
    title: "Telefoon staat de hele dag rinkelen — receptie is overbelast",
    desc: `Wat had niemand opgevolgd. Een automatisch follow-up bericht had het opgelost.`,
  },
  {
    icon: BsClockHistory,
    title: "Spoedgevallen bellen buiten kantoortijden zonder antwoord te krijgen",
    desc: `Tegen de tijd dat je terugbelt heeft de klant al een collega gebeld. Zonder automatische opvolging is het over.`,
  },
  {
    icon: BsGearFill,
    title: "Vaccinatie-herinneringen handmatig versturen kost te veel tijd",
